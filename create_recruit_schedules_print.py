...
<tr style="background-color:{color}">
 <td style="text-align:center; font-size:150%; padding:15px; line-height:120%;" width=20%>{slot_times[i]}</td>
"""
        outfile.write(rowtext)
        rowtext = f"""\
 <td style="text-align:center; font-size:150%; padding:15px; line-height:120%;" width=40%>{names[i]}</td>
 </div>
"""
        outfile.write(rowtext)
        
        rowtext = f"""<td style="text-align:center; font-size:150%; padding:15px; line-height:120%;" width=40%>{slot_location[i]}</td></tr>"""
...
def print_dayone(outfile):
    t = f"""\
        ...
        <table style="font-family:arial;">
          ...
          <tbody>
          <tr>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=20%" bgcolor="#FFFFFF"> 1:00pm - 5:00pm  </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> <strong> Arrival </strong> </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> Hampton Inn & Suites Providence Downtown <br><br> <em> 58 Weybosset St. <br> Providence, RI <br> 401-608-3500 </em>  </td>
          </tr>
          <tr>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=20%" bgcolor="#FFFFFF"> 3:00pm - 6:00pm  </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> <strong> Meet current students </strong> in the hotel lobby and collect welcome bags, including your itinerary  </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> Hampton Inn & Suites Providence Downtown </td>
          </tr>
          <tr>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=20%" bgcolor="#FFFFFF"> 5:45pm & 6:15pm  </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> <strong> Transportation to dinner - shuttle service </strong> </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> Meet in hotel lobby </td>
          </tr>
          <tr>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=20%" bgcolor="#FFFFFF"> 6:00pm - 8:30pm  </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> <strong> Dinner with students and faculty (casual) </strong> </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> Flatbread <br><br> <em> 161 Cushing St. <br> Providence, RI </em> </td>
          </tr>
          <tr>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=20%" bgcolor="#FFFFFF"> 8:00pm & 8:30pm  </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> <strong> Transportation to hotel - shuttle service </strong> </td>
          <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> Flatbread </td>
          </tr>
...
<table style="font-family:arial;">
  ...
  <tr>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=20%" bgcolor="#FFFFFF"> 9:00am - 12:00pm  </td>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> <strong> Group brunches </strong>  </td>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> Check with your host for more details </td>
  </tr>
  <tr>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=20%" bgcolor="#FFFFFF"> 10:00am - 12:00pm  </td>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> <strong> Neighborhood/Apartment tours </strong>  </td>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> Check with your host for more details </td>
  </tr>
  <tr>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=20%" bgcolor="#FFFFFF"> All day </td>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF">  <strong> Departures </strong>  </td>
  <td style="text-align:center; font-size:150%; padding:30px; line-height:120%;" width=40%" bgcolor="#FFFFFF"> You can depart from the hotel at any point after check-out, when you are ready to leave. You can arrange your own transportation and be reimbursed for your Uber or taxi. </td>
  </tr>
</table>
